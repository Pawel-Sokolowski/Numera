...
// Determine if this is a static deployment (GitHub Pages) or server deployment
...
export default defineConfig({
  ...
  define: {
    ...
    // Expose deployment mode to runtime
    __IS_STATIC_DEPLOY__: JSON.stringify(isStaticDeployment),
  },
  resolve: {
